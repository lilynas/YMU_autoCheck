...
def getUserJson(userInfo,token):
    ...
    return  {
        ...
        "areaStr": {"streetNumber":"","street":"致远路","district":"呈贡区","city":"昆明市","province":"云南省","town":"","pois":"云南民族大学(呈贡校区)","lng":102.85755399999898 + random.random()/1000,"lat":24.840647015644265 + random.random()/1000,"address":"呈贡区致远路云南民族大学(呈贡校区)","text":"云南省-昆明市","code":""},
